     ...
     <div className='todo-wrapper'>
        <div className='todo-input'>
          ...
          <div className='todo-input-item'>
            ...
            <input required type='text' value={newDescription} onChange={(e)=>setNewDescription(e.target.value)} placeholder='What is the description?'/>
          </div>
          ...
          allTodos.map((item,index)=>{
            if (currentEdit===index) {
              return (
                ...
                <textarea rows={4} placeholder='Updated Description' onChange={(e)=>handleUpdateDescription(e.target.value)} value={currentEditedItem.description}></textarea>
                <button type='button' onClick={handleUdateTodo} className='primaryBtn'>Update</button>
              </div>
              )
            } else {
              return(
